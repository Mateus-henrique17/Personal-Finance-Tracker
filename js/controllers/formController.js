...
export function formController(formElement) {
  ...
  const transactionData = { id: editingId || Date.now().toString(), title, currency, value, category, type, description, balance: 0 };
  ...
  saveTransaction(transactionData, editingId);
